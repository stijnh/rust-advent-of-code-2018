...
pub fn run(_: &[&str]) {
    ...
    println!("best guard: {} ({} minutes asleep)", best_guard, sleep_total[&best_guard]);
    println!("answer A: {} x {} = {}", minute, best_guard, minute * best_guard);
    ...
    println!("answer B: {} x {} = {}", answer.0, answer.1, answer.0 * answer.1);
}
