...
pub fn run(_: &[&str]) {
    ...
    for _ in 0..500usize {
        ...
        let total = current
            ...
            .enumerate()
            .filter(|(i, p)| **p == '#')
            .map(|(i, p)| first_plant as i64 + i as i64)
            .sum::<i64>();
    ...
    // Question A: score at generation 50000000000
